...
## Features
- Risk based prioritization using risk scoring
- Threat distribution visualization
- Identification of critical and high risk findings
- Attack path analysis for real world scenarios
- Priority remediation plan
- Structured findings with asset and mitigation details
...
AttackLens AI helps visualize attack paths and prioritize remediation based on real risk instead of volume.

## Future Improvements
- Add search and filtering
- Integrate real time vulnerability feeds
